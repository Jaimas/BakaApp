...
<body>
				...
				<div class="row">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Content Container
						</div>
	...
	<script src="<c:url value="/resources/js/theme/jquery.min.js" />"></script>
	<script src="<c:url value="/resources/js/theme/bootstrap.min.js" />"></script>
	<script src="<c:url value="/resources/js/theme/metisMenu.min.js" />"></script>
	<script src="<c:url value="/resources/js/theme/raphael-min.js" />"></script>
	<script src="<c:url value="/resources/js/theme/morris.min.js" />"></script>
	<script src="<c:url value="/resources/js/theme/sb-admin-2.js" />"></script>
</body>
</html>